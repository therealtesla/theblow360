...
const BasketScreen = () => {
     ...
     // Add a delivery fee (fixed or dynamic)
const deliveryFee = 1500; // Example: NGN 500

// Calculate the total including the delivery fee
const totalWithDelivery = basketTotal + deliveryFee;
...
>
    ...
    <View style = {tw `flex-row items-center py-3 px-4 my-5 bg-white`}> 
        ...
        />
        <Text style = {tw `flex-1`}>Deliver in 50-75mins</Text>
        <TouchableOpacity>
...
>
    ...
    <View style={tw`flex-row justify-between mt-2`}>
        ...
        <Text style={tw`font-bold`}>NGN {basketTotal + deliveryFee}</Text>
    </View>
    <TouchableOpacity
