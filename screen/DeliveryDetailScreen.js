...
import { ScrollView,View ,Image,Text, TextInput,Button,KeyboardAvoidingView,FlatList, SafeAreaView, SectionList, TouchableOpacity} from "react-native"
                     ...
                     <TextInput style= {{height:150,borderColor:"#ddd", textAlignVertical:"top",
                       ...
                       <Text style = {tw `font-bold `}>Charges</Text>
                        ...
                        <View style = {tw `py-2 justify-evenly  `}>
                            ...
                            <MyButton label='Submit' backgroundColor="green" onPress={()=>navigation.navigate("Payment")}/>
                        </View>
